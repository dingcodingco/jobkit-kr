...
معالجة وفحص روابط الوظائف المخزنة في صندوق الوارد بملف `data/pipeline.md`. يقوم المستخدم بإضافة روابط الفرص التي تسترعي انتباهه في أي وقت، ثم يقوم بتشغيل الأمر `/jobkit pipeline` ليقوم النظام بمعالجتها وتقييمها بالكامل تلقائياً.
