...
Elabora gli URL degli annunci accumulati in `data/pipeline.md`. Il candidato aggiunge gli URL quando vuole, poi esegue `/jobkit pipeline` per elaborarli tutti in una volta.
