...
Processen bieden URL's aan die zijn verzameld in `data/pipeline.md`. De kandidaat voegt URL's toe wanneer hij maar wil en voert vervolgens `/jobkit pipeline` uit om ze allemaal in één keer te verwerken.
