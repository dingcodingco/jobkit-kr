...
Procesa las URLs de ofertas acumuladas en `data/pipeline.md`. El candidato añade URLs cuando quiere y luego lanza `/jobkit pipeline` para procesarlas todas de una vez.
