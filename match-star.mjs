...
if (!existsSync(STORY_BANK_PATH)) {
  ...
  console.error('Run /jobkit interview-prep on a role first to populate your story bank.');
  process.exit(1);
}
...
if (stories.length === 0) {
  ...
  console.error('Run /jobkit interview-prep on a role to add your first stories.');
  process.exit(1);
}
